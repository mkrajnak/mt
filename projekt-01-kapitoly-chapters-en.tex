...
Before generation process starts, it it necessary to monitor the state of tested applications. It is required that a fresh instance of an application with a default configuration has to be run for every test case. Therefore, after each generated test case there must be a restart and a cleanup of the application. This can be summed up into three steps:
\begin{enumerate}
