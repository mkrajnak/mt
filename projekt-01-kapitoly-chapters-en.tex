...
\begin{lstlisting}[language=Gherkin,caption={Final test generator report},label={gnome-termina-report}]
    ...
    Nodes without the coverage:
        ...
        :link:Click
    No errors found!
    Generation time: 1:52:58.190075
\end{lstlisting}

The developed test generator was able to generate 485 test cases while covering the 1701 event in the application. Test cases are covering menus, several smaller dialogs and \textit{Preferences} window which contains the majority of covered nodes. 
