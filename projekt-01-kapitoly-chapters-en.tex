...
In this section we present the integration of OCR in our work. Subsection \ref{OCR_optimizations} is dedicated to the implementation of image preprocessing methods in our test generator. Subsection \ref{OCR_steps} described integration of the OCR in executable test cases.  
