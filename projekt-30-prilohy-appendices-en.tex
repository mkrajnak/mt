...
\begin{enumerate}
    ...
    \item Based on the underlying Linux distrubtion (\textit{Fedora} or \textit{RHEL}), install the dependencies located in the \textit{install} folder: \\ \texttt{\$ cd install \&\& sudo dnf -y install ./*.rpm}
...
\chapter{Test Generator Bug Report}\label{bug}
...
\chapter{Examples of Generated Test Cases}\label{tests_example}
...
\chapter{Event Flow Graphs}\label{event_flow_graphs}
...
\dirtree{%
.1 /.
.2 CI\_test\_runs -- logs from performed CI test runs.
.2 examples -- examples of generated test cases for tested components.
.2 install -- required dependencies.
.2 testextractor -- source files of our test generator.
.2 xkrajn02.pdf -- final version of this thesis.
} 
